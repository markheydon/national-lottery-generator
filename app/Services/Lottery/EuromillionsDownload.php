...
class EuromillionsDownload
{
    ...
    public const HISTORY_DOWNLOAD_URL = 'https://api-dfe.national-lottery.co.uk/draw-game/results/33/download?interval=ONE_EIGHTY';
    ...
    {
        $override = getenv('LOTTERY_DOWNLOAD_URL_EUROMILLIONS');
