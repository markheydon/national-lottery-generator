...
- [x] T002 Create `SetForLifeDownload` in `src/Services/Lottery/SetForLifeDownload.php`
- [x] T003 Create `SetForLifeGenerate` in `src/Services/Lottery/SetForLifeGenerate.php`
